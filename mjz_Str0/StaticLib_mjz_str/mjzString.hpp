  ...
  class malloc_wrapper {
    ...
    public:
      ...
      inline void memset( int _Val ) {
        if ( m_cap_size ) {
          ::memset( get_ptr(), _Val, m_cap_size ); } }
  ...
  struct SHA1_CTX : public SHA256_CTX {
    ...
    protected:
      static constexpr void sha1_transform( SHA1_CTX * ctx, const BYTE data[] ) {
        ...
        ctx->state[2] += c;
        ctx->state[3] += d;
        ctx->state[4] += e; } // namespace mjz_ard
...
namespace short_string_names {
  ...
  typedef mjz_ard::mjz_str_view mstrv; } // namespace short_string_names
...
namespace have_mjz_ard_removed {
  ...
  typedef mjz_ard::mjz_str_view mstrview;
  typedef mjz_ard::mjz_str_view mstrv; } // namespace have_mjz_ard_removed
namespace std {
  template <>
  struct hash<mjz_ard::basic_mjz_Str_view> {
    size_t operator()( const mjz_ard::basic_mjz_Str_view & k ) const {
      return mjz_ard::SHA1_CTX::SHA_1( k.c_str(), k.length() ).get_as_64bit_hash(); } }; // namespace std::hash
  ...
  struct hash<mjz_ard::mjz_str_view> {
    size_t operator()( const mjz_ard::mjz_str_view & k ) const {
      return mjz_ard::SHA1_CTX::SHA_1( k.data(), k.length() ).get_as_64bit_hash(); } }; // namespace std::hash
  template <>
