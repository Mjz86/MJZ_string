...
// iterator_template_ptr_warper Class
 ...
 class iterator_template_ptr_warper {
  ...
  public:
   ...
   inline constexpr iterator_template_ptr_warper() noexcept
        : m_iterator() {}
 ...
 class mjz_arena_allocator_t {
  ...
  public:
   ...
   void *realloc(void *ptr, size_t size) {
    ...
    if (index != not_valid)
      std::memmove(get_ptr(index), ptr,
                               get_real_size(index_of_ptr));
...
inline mjz_ard::basic_mjz_allocator<uint8_t>
...
template <class Type, size_t m_Size, bool error_check = 1,
          ...
          class ptr_alloc_warpper = mjz_allocator_warpper<Type>>        // i promise  that their is no allocation
